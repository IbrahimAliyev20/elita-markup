...
function BlogDetails({ blog }: BlogDetailsProps) {
  ...
  return (
    <div className="flex flex-col gap-6 font-manrope pb-10">
      ...
      <div className="flex w-full gap-5 justify-between border-t-[1px] border-elementSecondaryDate/20 pt-5"> 
        <div className="">
          <p className="text-elementSecondaryDate text-base font-bold leading-6 text-right">
            {dateString}
          </p>
        </div>
        <div className="flex items-center gap-3">
          <p className="text-elementSecondaryDate text-lg font-bold leading-6">
            {t("share")} :
          </p>
          <button
